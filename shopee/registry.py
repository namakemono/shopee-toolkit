...
def get_entries():
    return [
        ...
        ImageEntry(
            ...
            weights_filepath    = "../input/effnetb3-256x256-arcface/effnetb3-256x256-arcface/model_efficientnet_b3_IMG_SIZE_256_arcface_even2odd.bin",
            image_size          = 256,
            preprocess_input    = tf.keras.applications.efficientnet.preprocess_input,
            train_embeddings_filepath = "../input/effnetb3-256x256-arcface/effnetb3-256x256-arcface/train-embeddings-effnet-b3_256x256-kf0.npy"
        ),
        ImageEntry(
